...
/**
 * One collapsible group of policy fields. A native `<details>` replaces the
 * Bootstrap accordion: it opens and closes from the keyboard for free, and any
 * number of sections can be open at once, which suits a form that people scan
 * top to bottom.
 */
function PolicySection({ icon, title, defaultOpen, children }) {
  return (
    <details open={defaultOpen} className="border border-line bg-panel">
      <summary className="cursor-pointer list-none px-[18px] py-[12px] font-semibold text-ink marker:content-['']">
        <FontAwesomeIcon icon={icon} /> {title}
      </summary>
      <div className="flex flex-col gap-4 border-t border-line px-[18px] py-[16px]">{children}</div>
    </details>
  );
}
...
export class PolicyEditor extends Component {
  ...
  render() {
    ...
    return (
      <>
        <form className="flex flex-col gap-4" onSubmit={this.saveChanges}>
          <div className="flex flex-col gap-3">
            <PolicySection icon={faCalendarTimes} title="Snapshot Retention">
              <SectionHeaderRow />
              <Row>
            ...
            <PolicySection icon={faFolderOpen} title="Files">
              <SectionHeaderRow />
              <Row>
                <LabelColumn
                  name="Ignore Files"
            ...
            <PolicySection icon={faExclamationTriangle} title="Error Handling">
              <SectionHeaderRow />
              <Row>
            ...
            <PolicySection icon={faFileArchive} title="Compression">
              <SectionHeaderRow />
              <Row>
                <LabelColumn
            ...
            <PolicySection icon={faClock} title="Scheduling" defaultOpen>
              <SectionHeaderRow />
              <Row>
                <LabelColumn
                  name="Snapshot Frequency"
                  help="How frequently to create snapshots in the WarpHold desktop app or server (has no effect outside of the server mode)"
                />
                <WideValueColumn>
                  <Control
                    as="select"
            ...
            <PolicySection icon={faUpload} title="Upload">
              <SectionHeaderRow />
              <Row>
                <LabelColumn
            ...
            <PolicySection icon={faCogs} title="Snapshot Actions">
              <SectionHeaderRow />
              {ActionRowScript(
                this,
            ...
            <PolicySection icon={faCog} title="Folder Actions">
              <SectionHeaderRow />
            ...
            <PolicySection icon={faFileAlt} title="Logging">
              <SectionHeaderRow />
              <Row>
            ...
            <PolicySection icon={faMagic} title="Other">
              <Row>
                <LabelColumn
              ...
              <Row>
                ...
                <WideValueColumn>
                  <pre className="m-0 overflow-auto font-mono text-[11px] text-muted">
          ...
          <div className="flex items-center gap-3">
            ...
            {!this.state.isNew && !this.props.embedded && (
              <Button variant="danger" disabled={this.isGlobal() || this.state.saving} onClick={this.deletePolicy}>
                Delete Policy
              </Button>
            )}
            {this.state.saving && <Spinner size={16} />}
          </div>
        </form>
      </>
    );
